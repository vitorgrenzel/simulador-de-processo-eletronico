    ...
    value: function adjustImage(direction) {
      ...
      tmpImage.addEventListener('error', function (event) {
        ...
        if (_this5.options.alertError) {
          console.error(_this5.options.alertErrorMessage);
        }
      ...
      tmpImage.addEventListener('load', function (event) {
        ...
        var imageFullScreen = fullScreen(event.target.height, event.target.width);
        var imageWidth = imageFullScreen.width,
          imageHeight = imageFullScreen.height;
      ...
      function fullScreen(height, width) {
        ...
        if (height > width) {
          width = Math.abs((screenHeight * width) / height);
          height = screenHeight;
        } else {
          height = Math.abs((screenWidth * height) / width);
          width = screenWidth;
        }
        return {
